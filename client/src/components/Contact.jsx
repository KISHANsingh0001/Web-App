...
const Contact = () => {
  ...
  const [formMessage, setFormMessage] = useState(""); // To show success or error message after submission
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormMessage("Form submitted successfully! We will get back to you soon.");
      e.target.reset(); // Reset form fields
    } catch (error) {
      console.error("Error submitting form:", error);
      setFormMessage("There was an issue submitting your form. Please try again.");
    } finally {
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Contact Form */}
        <form className="contact-form grid gap-8 max-w-xl mx-auto" onSubmit={handleSubmit}>
          <div className="form-group flex flex-col">
            <label className="font-semibold text-gray-700 mb-2">
              First Name (required) *
            </label>
          ...
          <div className="form-group flex flex-col">
            ...
            <select name="inquiryType" className="p-4 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-300">
              <option value="">- Select -</option>
              <option value="Autism Support Resources">Autism Support Resources</option>
              <option value="Therapy Programs">Therapy Programs</option>
              <option value="Community Support">Community Support</option>
          ...
          <div className="flex items-center gap-2">
            <input type="checkbox" name="agreeToPolicy" className="h-5 w-5" required />
            <span className="text-gray-600 text-sm">
              I agree to the privacy policy and terms of service.
            </span>
          </div>
