  ...
  return (
    <>
      <div className="my-8 p-5 pb-10  bg-blue-800 min-h-[500px] overflow-hidden">
        ...
        <div className="md:flex-row flex flex-col justify-between p-10 gap-4">
          ...
          <Card2
            title={"2.Denial"}
            img={img2}
            desc={"No this cannot happen to me or my child :("}
          />
          <Card2
            title={"3.Late Acceptance"}
            img={img3}
            desc={
      ...
      <div className="flex md:flex-row flex-col gap-10 justify-between md:mt-10 mx-[6%]">
        ...
        <span className="max-w-[750px] min-w-80 flex justify-center items-center m-10">
          <img
            src={img5}
            alt="Autism & ADHD is not something to be fixed 
