...
const ScheduleTherapy = () => {
  return (
    <div className="flex flex-col items-center px-6 pb-6 pt-6 min-h-screen">
      ...
      <div className="mt-10">
        <button className="btn text-white bg-[#CB6BE5] flex justify-center items-center border-[#CB6BE5] hover:border-[#CB6BE5] rounded-[10px] px-6 py-3 h-[60px] font-poppins font-semibold text-lg md:text-xl min-h-0 hover:bg-[#CB6BE5]">
          Schedule Now
        </button>
      </div>
    </div>
